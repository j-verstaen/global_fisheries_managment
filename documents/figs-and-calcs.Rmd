...
glm <- glm(formula = CatchShare ~ gdp_center + SpeciesCat, family = "binomial", data = join)
glm
...
glm_broad <- glm(formula = CatchShare ~ gdp_center + MainCat, family = "binomial", data = join_mutate)
glm_broad

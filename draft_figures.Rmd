...
Notes:
- Corbett's ITQ data is only until 2012. Chris's upside data is now updated until 2016 with the more recent RAM data that Dan had. I ran all the figure and regressions under two "scenerios": 

    1. until 2012
    2. past 2012. extracted information about which fisheries had ITQs in 2012 and applied it to the same fisheries into the future. This doesn't take into account other fisheries implement ITQs past 2012, or if fisheries stop ITQs. Only countries with ITQs in 2012 are : Australia, USA, Canda, Japan, Peru, Argentina, South Africa, New Zealand

- for all ITQ related analyzes, limited to fisheries that Corbette had data on. I remove the fisheries that have no information on presence or absence of ITQs. I am unsure if this is biasing the data; should we assume that the fisheries with no information on ITQs have no ITQs or not? This seems like it woud be biased as well. 
...
###Total Catch ITQ, No ITQ, TURF in 2012
```{r}
ITQ_projection <- readRDS("data/ITQ_projection.rds")
...
2012 total catch:
ITQs: 7,420,003
No ITQ: 142,231 (all USA)
TURF:1,301,000 (all Japan)
**note: what units is the catch in the upside/rams data?**

###Total Catch ITQ, No ITQ, TURF in 2016
```{r}
...
2016 total catch:
ITQs: 27,830,933
No ITQ: 266,328,075 (all in the USA)
TURF:1,505,000 (all in Japan)


**note: This analyze does not include TURF information from DiscoverTurf GP because that data is not fishery specific enough to merge with the upside/Corbette data**
...
```
##5.	For MPA filter only for those that are “All” for No Take
a.	Total area for each country
b.	Top ten countries by area
i.	make a bar graph and each x-axis label is a country
